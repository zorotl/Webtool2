                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            Fix hinterlegte Umrechnungsformeln machen das Umrechnen zum Kinderspiel.<br><br>
                            Und das Resultat kann auch gleich in den Zwischenspeicher kopiert werden. Nicht dass man
                            das korrekte Resultat noch falsch abschreibt.
                        </p>
                        <a href="#" class="btn btn-primary">Zum Rechner</a>
                    </div>
                </div>
            </div>
        </div>
