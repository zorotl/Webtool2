...
{{--                            @endif--}}
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    @if(Auth::user()->id == 1 && Auth::user()->name === "Martin Striednig")
                                        <a class="dropdown-item" href="{{ route('register') }}">User hinzufügen</a>
                                    @endif
        ...
        <footer class="footer mt-auto py-3 bg-primary text-white text-center">
            <ul class="list-inline">
                ...
                <li class="list-inline-item">&copy; <?php echo date("Y"); ?> Webtools</li>
            </ul>
        </footer>
